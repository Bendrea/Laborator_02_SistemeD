...
public class MultiCastL2 {
    ...
    public static void main(String[] args) {
        ...
        final String helloMessage = " Hello! Sunt " + CLIENT_NAME;
                ...
                while (true) {
                    ...
                    if (stringMessage.equalsIgnoreCase("x")) {
                     ...
                     if (stringMessage.equalsIgnoreCase("r")) {
                        String stringMessageAndClientName = CLIENT_NAME + ": " + lastmessage;
